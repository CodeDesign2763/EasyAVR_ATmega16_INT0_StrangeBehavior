...
1. Описание использованного в ходе эксперимента оборудования
2. Программа, вызвавшая странное поведение.
3. Суть странного поведения
4. Исследование странного поведения
	- Гипотеза №1
	- Гипотеза №2
	- План эксперимента
...
## Программа, вызвавшая странное поведение
